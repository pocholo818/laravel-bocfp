<div class="page-header">
    <div class="header-wrapper row m-0">
        <div class="header-logo-wrapper col-auto p-0">
            <div class="logo-wrapper">
                <a href="{{route('backoffice.index')}}">
                    <img class="img-fluid for-light" src="{{asset('assets/backoffice/images/logo/logo.png')}}" alt="">
                    <img class="img-fluid for-dark" src="{{asset('assets/backoffice/images/logo/logo_dark.png')}}" alt="">
                </a>
            </div>
        ...
        <div class="nav-right col-xxl-7 col-xl-6 col-md-7 col-8 pull-right right-header p-0 ms-auto">
            <ul class="nav-menus">
                <li class="profile-nav dropdown-click pe-0 py-0">
                    ...
                    <ul class="profile-dropdown onhover-show-div profile-list">
                        <li>
                            <a href="{{-- route('backoffice.profile.index') --}}">
                        ...
                        {{-- <li>
                            <a href="{{ route('backoffice.profile.change_password') }}">
