...
<div class="page-title">
    <div class="row">
        ...
        <li class="breadcrumb-item"><a class="text-muted" href="{{ route('backoffice.announcement.index') }}">Announcements</a></li>
                <li class="breadcrumb-item"><a class="text-muted">Create Announcement</a></li>
            </ol>
        </div>
    </div>
</div>
                ...
                <div class="row">
                    <div class="col">
                        <div class="mb-3 row">
                            ...
                            <div class="">
                                <input type="text" class="form-control" name="title" value="{{ old('title') }}" placeholder="e.g. Barangay Feeding Program">
