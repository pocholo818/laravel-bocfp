                ...
                <div class="row">
                    <div class="col">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" id="input_contact" name="contact_number" value="{{ old('contact_number',$record->contact_number) }}" placeholder="Enter Contact Number">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-8">
                                <textarea class="form-control" id="input_address" name="address" placeholder="Enter Address">{{ old('address',$record->address) }}</textarea>
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" id="input_purok" name="purok" value="{{ old('purok',$record->purok) }}" placeholder="Enter Purok" maxlength="2">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="household_id" value="{{ old('household_id',$record->household_id) }}" placeholder="Enter Household ID">
