(function ($) {
  ...
  $(document).ready(function () {
    ...
    $(".customizer-color li").on("click", function () {
      ...
      $("#color").attr("href", "${asset_url}/css/" + color + ".css");
